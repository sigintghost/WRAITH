...
'risk': 'Rank all hosts by risk. Output ONLY a table: IP | RISK | PRIMARY THREAT. Max 2 sentences per host. No headers, no narrative, no recommendations section. Sort CRITICAL first. End with one sentence: the single most dangerous condition right now. Nothing else.',
